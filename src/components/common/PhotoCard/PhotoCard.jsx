      ...
      <div className={styles.imgWrap}>
        ...
        {variant === "mySale" && status === "ON_SALE" && (
          <div className={styles.saleTag}>
            {!hasPendingExchange ? (
              <div className={styles.onSale}>판매 중</div>
            ) : (
              <div className={styles.onChange}>교환 제시 대기 중</div>
            )}
          </div>
        )}
      </div>
      ...
      <div className={styles.textWrap}>
        ...
        <div className={styles.infoWrap}>
          <div className={styles.gradeCategory}>
            <div className={gradeClass[grade]}>{grade?.replace("_", " ")}</div>
        ...
        <div className={styles.saleInfo}>
          {showPrice && (
            <div className={styles.price}>
              ...
              <div className={styles.data}>{price} P</div>
            </div>
          )}
